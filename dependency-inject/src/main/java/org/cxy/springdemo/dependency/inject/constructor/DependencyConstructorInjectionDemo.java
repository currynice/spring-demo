 ...
 */
package org.cxy.springdemo.dependency.inject.constructor;
...
//        annotationWay();
    ...
    public static void xmlWay(){
        ...
        String xmlResourcePath = "classpath:/META-INF/dependency-injection-constructor-context.xml";
...
//        beanDefinitionReader.loadBeanDefinitions(xmlResourcePath);
    ...
    private static BeanDefinition createUserHolder3BeanDefinition() {
        ...
        // addConstructorArgReference ,按顺序指定 args
        definitionBuilder.addConstructorArgReference("user3");
        return definitionBuilder.getBeanDefinition();
    }

    @Bean
    public UserHolder userHolder2(User myUser) {
        return new UserHolder(myUser);
    }
    ...
    public User myUser() {
        ...
        myUser.setId("2");
        myUser.setName("constructor-injection");
        return myUser;
    }
    ...
    public User user3() {
        User user3 = new User();
        user3.setId("3");
        user3.setName("constructor-injection");
        return user3;
    }
}
