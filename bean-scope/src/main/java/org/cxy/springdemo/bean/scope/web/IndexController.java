 ...
 */
package org.cxy.springdemo.bean.scope.web;

import org.cxy.springdemo.bean.scope.Brush;
...
public class IndexController {
    ...
    @Autowired
    private Brush brush; // CGLIB 代理后对象（不变的）
...
//        model.addAttribute("brush", brush);
        model.addAttribute("brushObject", brush);
